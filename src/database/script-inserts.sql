...
INSERT INTO empresa (nome_fantasia, razao_social, cnpj, email, ddi_telefone, ddd_telefone, telefone, codigo_ativacao) VALUES
('Sabor Express', 'SABOR EXPRESS COZINHAS INDUSTRIAIS LTDA', '12345678000180', 'contato@saborexpress.com.br', '+55', '11', '9987654321', 'ACT001'),
...
INSERT INTO endereco (logradouro, numero, bairro, cidade, uf, cep, complemento, matriz, fk_id_empresa) VALUES
('Rua das Cozinhas', '1500', 'Vila Nova', 'São Paulo', 'SP', '04442000', 'S/C', 0, 1),
('Rua França', '2879', 'Campo Azul', 'Bauru', 'SP', '02222900', 'S/C', 1, 2),
('Avenida Principal', '45', 'Centro', 'Rio de Janeiro', 'RJ', '06666001', 'S/C', 1, 3);



INSERT INTO usuario (nome, sobrenome, email, senha, tipo_usuario, status_usuario, fk_id_empresa, fk_id_adm) VALUES
('Godofredo Luis', 'Silva Santos', 'godofredo@saborexpress.com.br', 'Senha#123', 'admin', 'inativo', 1, NULL),
...
INSERT INTO setor (nome, categoria, descricao, codigo_setor, fk_id_empresa) VALUES 
('Panettones e Chocottones', 'Cocção', 'setor de cocção de panettones', '#A0001', 2),
...
INSERT INTO sensor (nome, codigo, localizacao, frequencia_leitura, rotulo, codigo_botijao, fk_id_setor, fk_EmpresaSetor) VALUES 
('Sensor GLP Panettones', 'GLP0010001', 'Área 4321', 10, NULL, '#BTJ001', 1, 2),  
